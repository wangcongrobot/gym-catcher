...
PATH_TO_UR5_XML = '/home/cong/workspace/DHER/gym-catcher/gym_catcher/envs/assets/ur5_gripper/ur5_keep_up.xml'
# Load the model and make a simulator
#model = mujoco_py.load_model_from_path(PATH_TO_HUMANOID_XML)
model = mujoco_py.load_model_from_path(PATH_TO_UR5_XML)
